...
use crate::{
    clients::{self, PlayerControlConsumer, QueueControlConsumer, ServerControlConsumer},
    ui::{
        model::TxToMain,
...
impl ServerRequestActor {
    ...
    pub fn start_actor(
        ...
        let server_client = clients::ServerControlConsumer::new(raw_client.clone());
        let player_client = clients::PlayerControlConsumer::new(raw_client.clone());
        let queue_client = clients::QueueControlConsumer::new(raw_client);
