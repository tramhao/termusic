...
mod tests {
    ...
    use crate::{
        new_database::{
            ...
            track_ops::{
                all_distinct_directories, all_distinct_genres, get_all_tracks, get_last_position,
                ...
                set_last_position, track_exists, AlbumRead, ArtistRead, RowOrdering, TrackRead,
            },
        },
        track::TrackMetadata,
    };
