...
mod tests {
    ...
    use crate::{
        new_database::{
            ...
            album_ops::{
                album_exists, count_all_albums, count_all_albums_artist_mapping,
                delete_albums_artist_mapping_for, delete_all_unreferenced_albums, get_all_albums,
                get_all_albums_like, get_all_artists_for_album, AlbumRead, RowOrdering,
            },
