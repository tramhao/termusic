...
use super::super::traits::{DeviceTrait, HostTrait, StreamTrait};
use super::super::{
...
impl Host {
    pub fn new() -> Result<Self, super::super::HostUnavailable> {
        Ok(Host)
    }
}
...
fn process_input(
    ...
    let timestamp = super::super::InputStreamTimestamp { callback, capture };
    let info = super::super::InputCallbackInfo { timestamp };
...
fn process_output(
...
) -> Result<(), BackendSpecificError> {
    {
        ...
        let timestamp = super::super::OutputStreamTimestamp { callback, playback };
        let info = super::super::OutputCallbackInfo { timestamp };
...
fn stream_timestamp(
    status: &alsa::pcm::Status,
    creation_instant: Option<std::time::Instant>,
) -> Result<super::super::StreamInstant, BackendSpecificError> {
    match creation_instant {
        ...
        Some(creation) => {
            ...
            let instant = super::super::StreamInstant::from_nanos_i128(duration.as_nanos() as i128)
...
fn frames_to_duration(frames: usize, rate: super::super::SampleRate) -> std::time::Duration {
