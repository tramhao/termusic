...
impl ColorTermusic {
    pub fn color(&self, alacritty_theme: &Alacritty) -> Option<Color> {
        match self {
            ColorTermusic::Foreground => parse_hex_color(&alacritty_theme.foreground),
            ColorTermusic::Background => parse_hex_color(&alacritty_theme.background),
            ColorTermusic::Black => parse_hex_color(&alacritty_theme.black),
            ColorTermusic::Red => parse_hex_color(&alacritty_theme.red),
            ColorTermusic::Green => parse_hex_color(&alacritty_theme.green),
            ColorTermusic::Yellow => parse_hex_color(&alacritty_theme.yellow),
            ColorTermusic::Blue => parse_hex_color(&alacritty_theme.blue),
            ColorTermusic::Magenta => parse_hex_color(&alacritty_theme.magenta),
            ColorTermusic::Cyan => parse_hex_color(&alacritty_theme.cyan),
            ColorTermusic::White => parse_hex_color(&alacritty_theme.white),
            ColorTermusic::LightBlack => parse_hex_color(&alacritty_theme.light_black),
            ColorTermusic::LightRed => parse_hex_color(&alacritty_theme.light_red),
            ColorTermusic::LightGreen => parse_hex_color(&alacritty_theme.light_green),
            ColorTermusic::LightYellow => parse_hex_color(&alacritty_theme.light_yellow),
            ColorTermusic::LightBlue => parse_hex_color(&alacritty_theme.light_blue),
            ColorTermusic::LightMagenta => parse_hex_color(&alacritty_theme.light_magenta),
            ColorTermusic::LightCyan => parse_hex_color(&alacritty_theme.light_cyan),
            ColorTermusic::LightWhite => parse_hex_color(&alacritty_theme.light_white),
            ColorTermusic::Reset => Some(Color::Reset),
        }
    }
    pub const fn as_usize(&self) -> usize {
        match self {
            ColorTermusic::Reset => 0,
            ColorTermusic::Foreground => 1,
            ColorTermusic::Background => 2,
            ColorTermusic::Black => 3,
            ColorTermusic::Red => 4,
            ColorTermusic::Green => 5,
            ColorTermusic::Yellow => 6,
            ColorTermusic::Blue => 7,
            ColorTermusic::Magenta => 8,
            ColorTermusic::Cyan => 9,
            ColorTermusic::White => 10,
            ColorTermusic::LightBlack => 11,
            ColorTermusic::LightRed => 12,
            ColorTermusic::LightGreen => 13,
            ColorTermusic::LightYellow => 14,
            ColorTermusic::LightBlue => 15,
            ColorTermusic::LightMagenta => 16,
            ColorTermusic::LightCyan => 17,
            ColorTermusic::LightWhite => 18,
        }
    }
}
